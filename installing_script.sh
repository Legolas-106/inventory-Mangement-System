...
ENV_FILE="inventoryMangSystem/.env"  # Update to your project name
...
REQUIREMENTS_FILE="inventoryMangSystem/requirements.txt"
...
sudo -u "$PG_SUPERUSER" psql -h "$DB_HOST" -p "$DB_PORT" <<EOF
-- Create the database
